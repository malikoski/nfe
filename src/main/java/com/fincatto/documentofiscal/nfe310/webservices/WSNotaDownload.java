...
import com.fincatto.documentofiscal.nfe.classes.evento.downloadnf.NFDownloadNFe;
...
class WSNotaDownload {
    ...
    NFDownloadNFeRetorno downloadNota(final String cnpj, final String chave) throws Exception {
        ...
        return new Persister(new DFRegistryMatcher(), new Format(0)).read(NFDownloadNFeRetorno.class,
    ...
    private OMElement efetuaDownloadNF(OMElement omElementConsulta) throws RemoteException {
        ...
        if (endpoint == null) {
            throw new IllegalArgumentException(
                    "Nao foi possivel encontrar URL para DownloadNF, autorizador " + autorizador.name());
        }
