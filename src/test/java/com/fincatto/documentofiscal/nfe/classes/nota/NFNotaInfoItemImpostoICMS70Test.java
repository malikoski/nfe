...
public class NFNotaInfoItemImpostoICMS70Test {
    ...
    public void naoDevePermitirBaseCalculoFcpComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS70().setBaseCalculoFcpSt(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirPercentualFcpStComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS70().setPercentualFcpSt(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirValorFcpStComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS70().setValorFcpSt(new BigDecimal("10000000000000"));
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        ...
        icms70.setDesoneracao(NFNotaMotivoDesoneracaoICMS.OUTROS);
        icms70.setValorICMSDesoneracao(new BigDecimal("999999999999.99"));
        icms70.setValorFcpSt(new BigDecimal("999999999999.99"));
        icms70.setPercentualFcpSt(new BigDecimal("99.99"));
        icms70.setBaseCalculoFcpSt(new BigDecimal("999999999999.99"));

        final String xmlEsperado
                = "<NFNotaInfoItemImpostoICMS70><orig>2</orig><CST>20</CST><modBC>3</modBC><pRedBC>99.99</pRedBC><vBC>999999999999.99</vBC><pICMS>99.99</pICMS><vICMS>999999999999.99</vICMS><modBCST>3</modBCST><pMVAST>99.99</pMVAST><pRedBCST>99.99</pRedBCST><vBCST>999999999999.99</vBCST><pICMSST>99.99</pICMSST><vICMSST>999999999999.99</vICMSST><vICMSDeson>999999999999.99</vICMSDeson><motDesICMS>9</motDesICMS><vBCFCPST>999999999999.99</vBCFCPST><pFCPST>99.99</pFCPST><vFCPST>999999999999.99</vFCPST></NFNotaInfoItemImpostoICMS70>";
