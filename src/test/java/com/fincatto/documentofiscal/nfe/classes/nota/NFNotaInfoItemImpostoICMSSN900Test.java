...
public class NFNotaInfoItemImpostoICMSSN900Test {
    ...
    public void naoDevePermitirBaseCalculoFcpComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMSSN900().setBaseCalculoFcpSt(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirPercentualFcpStComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMSSN900().setPercentualFcpSt(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirValorFcpStComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMSSN900().setValorFcpSt(new BigDecimal("10000000000000"));
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        ...
        icms900.setValorICMS(new BigDecimal("999999999999.99"));
        icms900.setValorICMSST(new BigDecimal("999999999999.99"));
        icms900.setValorFcpSt(new BigDecimal("999999999999.99"));
        icms900.setPercentualFcpSt(new BigDecimal("99.99"));
        icms900.setBaseCalculoFcpSt(new BigDecimal("999999999999.99"));

        final String xmlEsperado
                = "<NFNotaInfoItemImpostoICMSSN900><orig>0</orig><CSOSN>300</CSOSN><modBC>0</modBC><vBC>999999999999.99</vBC><pRedBC>99.99</pRedBC><pICMS>99.99</pICMS><vICMS>999999999999.99</vICMS><modBCST>1</modBCST><pMVAST>99.99</pMVAST><pRedBCST>99.99</pRedBCST><vBCST>999999999999.99</vBCST><pICMSST>99.99</pICMSST><vICMSST>999999999999.99</vICMSST><pCredSN>99.99</pCredSN><vCredICMSSN>999999999999.99</vCredICMSSN><vBCFCPST>999999999999.99</vBCFCPST><pFCPST>99.99</pFCPST><vFCPST>999999999999.99</vFCPST></NFNotaInfoItemImpostoICMSSN900>";
