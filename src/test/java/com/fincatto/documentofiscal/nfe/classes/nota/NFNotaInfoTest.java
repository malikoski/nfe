...
public class NFNotaInfoTest {
    ...
    public void deveObterPessoasAutorizadasDownloadNFeComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final List<NFPessoaAutorizadaDownloadNFe> pessoasAutorizadasDownloadNFe = Collections.singletonList(
    ...
    public void deveObterPagamentosComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        notaInfo.setVersao(new BigDecimal("9.99"));
        final List<NFNotaInfoPagamento> pagamentos = Collections.singletonList(
                FabricaDeObjetosFake.getNFNotaInfoPagamento());
    ...
    public void deveObterInformacoesAdicionaisComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoInformacoesAdicionais informacoesAdicionais
                = FabricaDeObjetosFake.getNFNotaInfoInformacoesAdicionais();
