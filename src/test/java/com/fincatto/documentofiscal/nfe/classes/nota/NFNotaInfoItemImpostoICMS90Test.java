...
public class NFNotaInfoItemImpostoICMS90Test {
    ...
    public void naoDevePermitirBaseCalculoFcpComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS90().setBaseCalculoFcp(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirPercentualFcpComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS90().setPercentualFcp(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirValorFcpComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS90().setValorFcp(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirBaseCalculoFcpStComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS90().setBaseCalculoFcpSt(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirPercentualFcpStComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS90().setPercentualFcpSt(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirValorFcpStComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS90().setValorFcpSt(new BigDecimal("10000000000000"));
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        ...
        icms90.setDesoneracao(NFNotaMotivoDesoneracaoICMS.OUTROS);
        icms90.setValorICMSDesoneracao(new BigDecimal("999999999999.99"));
        icms90.setBaseCalculoFcp(new BigDecimal("999999999999.99"));
        icms90.setPercentualFcp(new BigDecimal("99.99"));
        icms90.setValorFcp(new BigDecimal("999999999999.99"));
        icms90.setValorFcpSt(new BigDecimal("999999999999.99"));
        icms90.setPercentualFcpSt(new BigDecimal("99.99"));
        icms90.setBaseCalculoFcpSt(new BigDecimal("999999999999.99"));

        final String xmlEsperado
                = "<NFNotaInfoItemImpostoICMS90><orig>2</orig><CST>90</CST><modBC>3</modBC><vBC>999999999999.99</vBC><pRedBC>99.99</pRedBC><pICMS>99.99</pICMS><vICMS>999999999999.99</vICMS><vBCFCP>999999999999.99</vBCFCP><pFCP>99.99</pFCP><vFCP>999999999999.99</vFCP><modBCST>3</modBCST><pMVAST>99.99</pMVAST><pRedBCST>99.99</pRedBCST><vBCST>999999999999.99</vBCST><pICMSST>99.99</pICMSST><vICMSST>999999999999.99</vICMSST><vICMSDeson>999999999999.99</vICMSDeson><motDesICMS>9</motDesICMS><vBCFCPST>999999999999.99</vBCFCPST><pFCPST>99.99</pFCPST><vFCPST>999999999999.99</vFCPST></NFNotaInfoItemImpostoICMS90>";
