...
public class NFNotaInfoItemImpostoICMS51Test {
    ...
    public void naoDevePermitirBaseCalculoFcpComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS51().setBaseCalculoFcp(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirPercentualFcpComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS51().setPercentualFcp(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirValorFcpComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMS51().setValorFcp(new BigDecimal("10000000000000"));
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        ...
        icms51.setValorICMSDiferimento(new BigDecimal("999999999999.99"));
        icms51.setValorICMSOperacao(new BigDecimal("999999999999.99"));
        icms51.setValorFcp(new BigDecimal("999999999999.99"));
        icms51.setPercentualFcp(new BigDecimal("99.99"));
        icms51.setBaseCalculoFcp(new BigDecimal("999999999999.99"));

        final String xmlEsperado
                = "<NFNotaInfoItemImpostoICMS51><orig>0</orig><CST>40</CST><modBC>3</modBC><pRedBC>99.99</pRedBC><vBC>999999999999.99</vBC><pICMS>99.99</pICMS><vICMSOp>999999999999.99</vICMSOp><pDif>99.9999</pDif><vICMSDif>999999999999.99</vICMSDif><vICMS>999999999999.99</vICMS><vBCFCP>999999999999.99</vBCFCP><pFCP>99.99</pFCP><vFCP>999999999999.99</vFCP></NFNotaInfoItemImpostoICMS51>";
