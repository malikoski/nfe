...
public class NFNotaInfoItemImpostoICMSSN201Test {
    ...
    public void naoDevePermitirBaseCalculoFcpComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMSSN201().setBaseCalculoFcpSt(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirPercentualFcpStComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMSSN201().setPercentualFcpSt(new BigDecimal("10000000000000"));
    }

    @Test(expected = NumberFormatException.class)
    public void naoDevePermitirValorFcpStComTamanhoInvalido() {
        new NFNotaInfoItemImpostoICMSSN201().setValorFcpSt(new BigDecimal("10000000000000"));
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        ...
        icms201.setValorCreditoICMSSN(new BigDecimal("99999999999.99"));
        icms201.setValorICMSST(new BigDecimal("99999999999.99"));
        icms201.setValorFcpSt(new BigDecimal("999999999999.99"));
        icms201.setPercentualFcpSt(new BigDecimal("99.99"));
        icms201.setBaseCalculoFcpSt(new BigDecimal("999999999999.99"));        

        final String xmlEsperado = "<NFNotaInfoItemImpostoICMSSN201><orig>0</orig><CSOSN>300</CSOSN><modBCST>0</modBCST><pMVAST>99.99</pMVAST><pRedBCST>99.99</pRedBCST><vBCST>99999999999.99</vBCST><pICMSST>99.99</pICMSST><vICMSST>99999999999.99</vICMSST><pCredSN>99.99</pCredSN><vCredICMSSN>99999999999.99</vCredICMSSN><vBCFCPST>999999999999.99</vBCFCPST><pFCPST>99.99</pFCPST><vFCPST>999999999999.99</vFCPST></NFNotaInfoItemImpostoICMSSN201>";
