...
import com.fincatto.documentofiscal.nfe.classes.nota.NFImpostoDevolvido;
...
import com.fincatto.documentofiscal.nfe.classes.nota.NFInfoCupomFiscalReferenciado;
...
import com.fincatto.documentofiscal.nfe.classes.nota.NFInformacaoImpostoDevolvido;
...
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoCartao;
...
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoFatura;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoICMSTotal;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoISSQNTotal;
...
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemDetalheExportacao;
...
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemImpostoCOFINSAliquota;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemImpostoCOFINSNaoTributavel;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemImpostoCOFINSOutrasOperacoes;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemImpostoCOFINSQuantidade;
...
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemImpostoIPITributado;
...
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemImpostoPISAliquota;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemImpostoPISNaoTributado;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemImpostoPISOutrasOperacoes;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemImpostoPISQuantidade;
...
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemProduto;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemProdutoArmamento;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemProdutoCombustivel;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemProdutoCombustivelCIDE;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemProdutoDeclaracaoImportacao;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoItemProdutoDeclaracaoImportacaoAdicao;
...
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoObservacao;
...
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoRetencaoICMSTransporte;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoRetencoesTributos;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoTotal;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoTransportador;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoTransporte;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoVeiculo;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaInfoVolume;
import com.fincatto.documentofiscal.nfe.classes.nota.NFNotaProcessada;
...
public class FabricaDeObjetosFake {
    ...
    public static NFNotaInfoItemImpostoICMSUFDestino getNFNotaaInfoItemImpostoICMSUFDestino() {
        ...
        icmsUFDestino.setValorBaseCalculoFcpUfDestino(new BigDecimal("9999999999999.99"));
    ...
    public static NFEventoInutilizacaoDados getNFEventoCancelamentoDados() {
        ...
        dados.setJustificativa(
                "u2MGhwXFQDFtSuKsLkmgowBZNNhOWBL4JKIqYnIj5iDPTAUqHSwKL1O2olgmZwigRS1P58Zoc1qDxzqmvv3hBE1LYuLHNPbFXuLwM5ZxvH7xfSpnkX5VBGjrkR3cuiXLr1uz3chFb9JrNY5xU3X0eF9Byc2Q9TkPbFyPj7iRwwQVMNt6FGvpUyRMHGmhSDYhFRD2Dst0UaauvA4V0breWHyN4WUSEm9z377jXHNwtVLQQCxB2wcEIZGWVIT4CF5");
    ...
    public static NFEventoInutilizacaoDados getNFEventoInutilizacaoDados() {
        ...
        dados.setIdentificador(
                "ID" + uf.getCodigoIbge() + String.valueOf(anoInutilizacaoNumeracao) + cnpjEmitente + modelo.getCodigo() + serieTamanhoMaximo + numeroInicialTamanhoMaximo + numeroFinalTamanhoMaximo);
        return dados;
    }
    ...
    public static NFInfoEventoManifestacaoDestinatario getNFInfoEventoManifestacaoDestinatario() {
        final NFInfoEventoManifestacaoDestinatario infoEventoManifestacaoDestinatario
                = new NFInfoEventoManifestacaoDestinatario();
        ...
        infoEventoManifestacaoDestinatario.setManifestacaoDestinatario(
                FabricaDeObjetosFake.getNFInfoManifestacaoDestinatario());
    ...
    public static NFNotaInfoPagamento getNFNotaInfoPagamento() {
        ...
        pagamento.setDetalhamentoPagamento(Collections.singletonList(getNFNotaInfoDetalhamentoPagamento()));
        pagamento.setValorTroco(new BigDecimal("999999999999.99"));
        return pagamento;
    }

    public static NFNotaInfoDetalhamentoPagamento getNFNotaInfoDetalhamentoPagamento() {
        final NFNotaInfoDetalhamentoPagamento detPagamento = new NFNotaInfoDetalhamentoPagamento();
        detPagamento.setCartao(FabricaDeObjetosFake.getNFNotaInfoCartao());
        detPagamento.setValorPagamento(new BigDecimal("999999999999.99"));
        detPagamento.setFormaPagamentoMoeda(NFFormaPagamentoMoeda.CARTAO_CREDITO);
    ...
    public static NFNota getNFNota1() {
        ...
        info.setPessoasAutorizadasDownloadNFe(Collections.singletonList(
                FabricaDeObjetosFake.getPessoaAutorizadaDownloadNFe()));
        ...
        identificacao.setJustificativaEntradaContingencia(
    ...
    private static NFNotaInfoItemProduto getProdutoMedicamento() {
        ...
        produtoMedicamento.setDeclaracoesImportacao(Collections.singletonList(
                FabricaDeObjetosFake.getNFNotaInfoItemProdutoDeclaracaoImportacao()));
        produtoMedicamento.setDescricao(
                "OBS0ztekCoG0DSSVcQwPKRV2fV842Pye7mED13P4zoDczcXi4AMNvQ7BKBLnHtLc2Z9fuIY1pcKmXSK1IJQSLEs5QWvVGyC74DyJuIM0X7L0cqWPZQii5JtP");
    ...
    public static NFNotaInfoItem getNFNotaInfoItem() {
        ...
        item.setInformacoesAdicionais(
                "");
        item.setNumeroItem(990);
    ...
    public static NFNotaInfoInformacoesAdicionais getNFNotaInfoInformacoesAdicionais() {
        ...
        infoAdicionais.setInformacoesAdicionaisInteresseFisco(
                "");
    ...
    public static NFNotaInfoItemProduto getNFNotaInfoItemProduto() {
        ...
        produto.setDeclaracoesImportacao(Collections.singletonList(
                FabricaDeObjetosFake.getNFNotaInfoItemProdutoDeclaracaoImportacao()));
    ...
    public static NFNotaInfoItemProdutoMedicamento getNFNotaInfoItemProdutoMedicamento() {
        ...
        //Na versão 4.00 essas propriedades não existem
...
//        medicamento.setQuantidade(new BigDecimal("9999999.999"));
        ...
        medicamento.setCodigoAnvisa("yq50jVDZsvQVN");
        return medicamento;
    }

    public static NFNotaInfoItemProdutoDeclaracaoImportacao getNFNotaInfoItemProdutoDeclaracaoImportacao() {
        final NFNotaInfoItemProdutoDeclaracaoImportacao declaraoImportacao
                = new NFNotaInfoItemProdutoDeclaracaoImportacao();
        declaraoImportacao.setAdicoes(Collections.singletonList(
                FabricaDeObjetosFake.getNFNotaInfoItemProdutoDeclaracaoImportacaoAdicao()));
    ...
    public static NFNotaInfoItemProdutoArmamento getNFNotaInfoItemProdutoArmamento() {
        ...
        armamento.setDescricao(
                "");
    ...
    public static NFNotaInfoItemProdutoDeclaracaoImportacaoAdicao getNFNotaInfoItemProdutoDeclaracaoImportacaoAdicao() {
        final NFNotaInfoItemProdutoDeclaracaoImportacaoAdicao importacaoAdicao
    ...
    public static NFNotaInfoItemImpostoPISQuantidade getNFNotaInfoItemImpostoPISQuantidade() {
        ...
        pisQuantidade.setSituacaoTributaria(
                NFNotaInfoSituacaoTributariaPIS.OPERACAO_TRIBUTAVEL_QUANTIDADE_VENDIDA_POR_ALIQUOTA_POR_UNIDADE_PRODUTO);
    ...
    public static NFNotaInfoItemImpostoPISNaoTributado getNFNotaInfoItemImpostoPISNaoTributado() {
        ...
        pisNaoTributado.setSituacaoTributaria(
                NFNotaInfoSituacaoTributariaPIS.OPERACAO_TRIBUTAVEL_MONOFASICA_ALIQUOTA_ZERO);
    ...
    public static NFNotaInfoItemImpostoCOFINSQuantidade getNFNotaInfoItemImpostoCOFINSQuantidade() {
        ...
        cofinsQuantidade.setSituacaoTributaria(
                NFNotaInfoSituacaoTributariaCOFINS.OPERACAO_TRIBUTAVEL_QUANTIDADE_VENDIDA_POR_ALIQUOTA_POR_UNIDADE_PRODUTO);
    ...
    public static NFNotaInfoItemImpostoCOFINSOutrasOperacoes getNFNotaInfoItemImpostoCOFINSOutrasOperacoes() {
        final NFNotaInfoItemImpostoCOFINSOutrasOperacoes outrasOperacoes
    ...
    public static NFNotaInfoItemImpostoCOFINSNaoTributavel getNFNotaInfoItemImpostoCOFINSNaoTributavel() {
        final NFNotaInfoItemImpostoCOFINSNaoTributavel cofinsNaoTributado
                = new NFNotaInfoItemImpostoCOFINSNaoTributavel();
        cofinsNaoTributado.setSituacaoTributaria(
                NFNotaInfoSituacaoTributariaCOFINS.OPERACAO_TRIBUTAVEL_MONOFASICA_ALIQUOTA_ZERO);
    ...
    public static NFNotaInfoItemImpostoCOFINSAliquota getNFNotaInfoItemImpostoCOFINSAliquota() {
        ...
        cofinsAliquota.setSituacaoTributaria(
                NFNotaInfoSituacaoTributariaCOFINS.OPERACAO_TRIBUTAVEL_CUMULATIVO_NAO_CUMULATIVO);
    ...
    public static NFNotaInfoICMSTotal getNFNotaInfoICMSTotal() {
        ...
        icmsTotal.setValorTotalFcpSt(new BigDecimal("999999999999.99"));
        icmsTotal.setValorTotalFcpStRetido(new BigDecimal("999999999999.99"));
    ...
    public static NFNotaInfoProcessoReferenciado getNFNotaInfoProcessoReferenciado() {
        ...
        processoReferenciado.setIdentificadorProcessoOuAtoConcessorio(
                "SziSRSIRZvYWlxcbmmJfRZsLgVHaHTurUL9ea1kwFe7fssrxTVSK6uaFwGO5");
